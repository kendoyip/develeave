        ...
        if type == "LVE01" or type == "LVE02" or leave_group_no == 1:
            ...
            if type == "LVE06":
                if (r['Day of Week'] == "Saturday" or r['Day of Week'] == "Sunday") or (r['Applied'] != "" and 'LVE' not in r['Applied']):
                    count -= 0.5
                if count > 5:
                    return ({"consecutive": True, "error_message" : "Reminder: No pay leave cannot exceed 5 consecutive working days, please contact HR", "result": None,  "Status_code": 506, "no_of_consective": sl_count})
